...
import com.universe.myweather.weather.Weather;
import com.universe.myweather.weather.WeatherBean;
import com.universe.myweather.weather.WeatherEnums;
import com.universe.myweather.weather.WeatherInterface;
import com.universe.myweather.weather.WeatherNow;
...
//            varTimeList.add(getObsTime().split("T")[0]);
            ...
            for (int i = 0; i < fixNameList.size(); i++) {
                if (i == 0) {
                    type = WeatherEnums.RECYCLERVIEW_TYPE_FULL;
                } else if (i > 0 && i < 5) {
                    type = WeatherEnums.RECYCLERVIEW_TYPE_HALF;
                } else {
                    type = WeatherEnums.RECYCLERVIEW_TYPE_QUARTER;
                }
